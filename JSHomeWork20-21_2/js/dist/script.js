...
var quiz = {
    ...
    questions: [{
        ...
        answer: 1,
        options: ['Кошке просто лень жевать', 'Челюсти кошки не двигаются из стороны в сторону', 'Не хочет запачкать шёрстку']
    }, {
        name: '№2. Почему кошка может пролезть в любое отверстие размером с её голову?',
        answer: 2,
        options: ['Кошка очень гибкое животное', 'В поисках вкусной еды, кошка способна на многое', 'У нее нет ключицы']
    }, {
        name: '№3. Почему кошки не любят сладкое?',
        answer: 0,
        options: ['У кошек нарушен ген, который ответственен за восприятие сладкого вкуса', 'Кошки следят за своим весом', 'Какое сладкое? Мясо давай!']
    }]
};
